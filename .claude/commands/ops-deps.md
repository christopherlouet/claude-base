...
|-------|------------------|
| `/project:security` | Audit vulnérabilités |
| `/project:test` | Tester après mise à jour |
| `/project:migrate` | Migration majeure |
| `/project:ci` | Automatiser les updates |
| `/project:audit` | Audit qualité complet |
