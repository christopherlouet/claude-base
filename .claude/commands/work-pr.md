...
|-------|------------------|
| `/project:review` | Self-review avant PR |
| `/project:commit` | Préparer les commits |
| `/project:explore` | Vérifier l'impact des changements |
| `/project:security` | Review sécurité si applicable |
