...
- [ ] T007 — [P] [US1] Test bats : un `docs/ARCHITECTURE.md` user pré-existant (avec contenu spécifique) reste byte-identique après install (cas user-project)
...
- [ ] T049 — Smoke end-to-end sur projet réel (user-project en local) : install fresh sur clone vierge + update sur install legacy
