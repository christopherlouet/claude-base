...
[![Tests](https://img.shields.io/badge/tests-645%20passing-brightgreen)](./tests)
...
- **<!-- count:presets -->11<!-- /count --> stack-specific presets** (`nextjs`, `react-vite-spa`, `fastapi`, `astro`, `cli-tools`, `homelab-proxmox`) installable via `claude-base init --preset <name> <path>`
...
│
├── tests/                       # <!-- count:tests -->645<!-- /count --> automated tests (bats)
...
### Test layout (<!-- count:testFiles -->28<!-- /count --> files, <!-- count:tests -->645<!-- /count --> tests)
