...
[![Tests](https://img.shields.io/badge/tests-969%20passing-brightgreen)](./tests)
...
| `tests/` | <!-- count:tests -->969<!-- /count --> bats tests across <!-- count:testFiles -->38<!-- /count --> files |
...
<!-- count:tests -->969<!-- /count --> bats tests across <!-- count:testFiles -->38<!-- /count --> files. A few anchors :
...
- <!-- count:tests -->969<!-- /count --> bats tests run on every PR (Linux + macOS), parallelised via `./scripts/test.sh`
