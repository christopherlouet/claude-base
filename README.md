...
- **<!-- count:presets -->9<!-- /count --> stack-specific presets** (`nextjs`, `react-vite-spa`, `fastapi`, `astro`, `cli-tools`, `homelab-proxmox`) installable via `claude-base init --preset <name> <path>`
...
│
├── tests/                       # <!-- count:tests -->631<!-- /count --> automated tests (bats)
...
### Test layout (<!-- count:testFiles -->28<!-- /count --> files, <!-- count:tests -->631<!-- /count --> tests)
