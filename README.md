...
[![Tests](https://img.shields.io/badge/tests-1543%20passing-brightgreen)](./tests)
...
| `tests/` | <!-- count:tests -->1543<!-- /count --> bats tests across <!-- count:testFiles -->67<!-- /count --> files |
...
<!-- count:tests -->1543<!-- /count --> bats tests across <!-- count:testFiles -->67<!-- /count --> files. A few anchors :
...
- <!-- count:tests -->1543<!-- /count --> bats tests run on every PR (Linux + macOS), parallelised via `./scripts/test.sh`
