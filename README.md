...
| `tests/` | <!-- count:tests -->695<!-- /count --> bats tests across <!-- count:testFiles -->32<!-- /count --> files |
...
<!-- count:tests -->695<!-- /count --> bats tests across <!-- count:testFiles -->32<!-- /count --> files. A few anchors :
...
- <!-- count:tests -->695<!-- /count --> bats tests run on every PR (Linux + macOS), parallelised via `./scripts/test.sh`
