...
```bash
curl -fsSL https://raw.githubusercontent.com/christopherlouet/claude-base/main/install.sh | bash -s -- --ref v5.4.1
```
...
- Pinned versions via git tags (current : v<!-- version -->5.4.1<!-- /version -->) with full `CHANGELOG.md` in Keep-a-Changelog format
