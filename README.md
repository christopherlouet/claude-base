...
| `tests/` | <!-- count:tests -->1426<!-- /count --> bats tests across <!-- count:testFiles -->58<!-- /count --> files |
...
<!-- count:tests -->1426<!-- /count --> bats tests across <!-- count:testFiles -->58<!-- /count --> files. A few anchors :
...
- <!-- count:tests -->1426<!-- /count --> bats tests run on every PR (Linux + macOS), parallelised via `./scripts/test.sh`
