...
[![Tests](https://img.shields.io/badge/tests-663%20passing-brightgreen)](./tests)
...
| `tests/` | <!-- count:tests -->663<!-- /count --> bats tests across <!-- count:testFiles -->29<!-- /count --> files |
...
<!-- count:tests -->663<!-- /count --> bats tests across <!-- count:testFiles -->29<!-- /count --> files. A few anchors :
...
- <!-- count:tests -->663<!-- /count --> bats tests run on every PR (Linux + macOS), parallelised via `./scripts/test.sh`
