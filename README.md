...
| `tests/` | <!-- count:tests -->789<!-- /count --> bats tests across <!-- count:testFiles -->33<!-- /count --> files |
...
<!-- count:tests -->789<!-- /count --> bats tests across <!-- count:testFiles -->33<!-- /count --> files. A few anchors :
...
- <!-- count:tests -->789<!-- /count --> bats tests run on every PR (Linux + macOS), parallelised via `./scripts/test.sh`
