...
[![Tests](https://img.shields.io/badge/tests-871%20passing-brightgreen)](./tests)
...
| `tests/` | <!-- count:tests -->871<!-- /count --> bats tests across <!-- count:testFiles -->36<!-- /count --> files |
...
<!-- count:tests -->871<!-- /count --> bats tests across <!-- count:testFiles -->36<!-- /count --> files. A few anchors :
...
- <!-- count:tests -->871<!-- /count --> bats tests run on every PR (Linux + macOS), parallelised via `./scripts/test.sh`
