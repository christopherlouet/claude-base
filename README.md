...
| `tests/` | <!-- count:tests -->2056<!-- /count --> bats tests across <!-- count:testFiles -->98<!-- /count --> files |
...
<!-- count:tests -->2056<!-- /count --> bats tests across <!-- count:testFiles -->98<!-- /count --> files. A few anchors :
