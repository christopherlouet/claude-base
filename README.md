...
| `tests/` | <!-- count:tests -->843<!-- /count --> bats tests across <!-- count:testFiles -->34<!-- /count --> files |
...
<!-- count:tests -->843<!-- /count --> bats tests across <!-- count:testFiles -->34<!-- /count --> files. A few anchors :
...
- <!-- count:tests -->843<!-- /count --> bats tests run on every PR (Linux + macOS), parallelised via `./scripts/test.sh`
