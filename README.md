...
The foundation ships <!-- count:commands -->112<!-- /count --> commands + <!-- count:agents -->47<!-- /count --> agents + <!-- count:skills -->53<!-- /count --> skills, but most skills are **thin pointers** pairing the canonical vendor source with a few foundation-specific discipline lines (security/GDPR wraps, anti-patterns, cross-skill orchestration). What's NOT pointer-shaped is the workflow layer:
...
|---|---|---|
| Slash commands | <!-- count:commands -->112<!-- /count --> across 9 domains (work, dev, qa, ops, doc, biz, growth, data, legal) | Manually triggered (`/work:work-plan`) |
...
## Available Commands (<!-- count:commands -->112<!-- /count -->)
...
It covers:
- Quick start guide
- Catalog of <!-- count:commands -->112<!-- /count --> commands, <!-- count:agents -->47<!-- /count --> agents, <!-- count:skills -->53<!-- /count --> skills, <!-- count:rules -->31<!-- /count --> rules
