...
| `tests/` | <!-- count:tests -->1332<!-- /count --> bats tests across <!-- count:testFiles -->51<!-- /count --> files |
...
<!-- count:tests -->1332<!-- /count --> bats tests across <!-- count:testFiles -->51<!-- /count --> files. A few anchors :
...
- <!-- count:tests -->1332<!-- /count --> bats tests run on every PR (Linux + macOS), parallelised via `./scripts/test.sh`
