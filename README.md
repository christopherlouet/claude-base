...
| `tests/` | <!-- count:tests -->964<!-- /count --> bats tests across <!-- count:testFiles -->38<!-- /count --> files |
...
<!-- count:tests -->964<!-- /count --> bats tests across <!-- count:testFiles -->38<!-- /count --> files. A few anchors :
...
- <!-- count:tests -->964<!-- /count --> bats tests run on every PR (Linux + macOS), parallelised via `./scripts/test.sh`
