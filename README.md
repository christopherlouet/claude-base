...
[![Tests](https://img.shields.io/badge/tests-804%20passing-brightgreen)](./tests)
...
| `tests/` | <!-- count:tests -->804<!-- /count --> bats tests across <!-- count:testFiles -->33<!-- /count --> files |
...
<!-- count:tests -->804<!-- /count --> bats tests across <!-- count:testFiles -->33<!-- /count --> files. A few anchors :
...
- <!-- count:tests -->804<!-- /count --> bats tests run on every PR (Linux + macOS), parallelised via `./scripts/test.sh`
