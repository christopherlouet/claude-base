...
| `tests/` | <!-- count:tests -->916<!-- /count --> bats tests across <!-- count:testFiles -->37<!-- /count --> files |
...
<!-- count:tests -->916<!-- /count --> bats tests across <!-- count:testFiles -->37<!-- /count --> files. A few anchors :
...
- <!-- count:tests -->916<!-- /count --> bats tests run on every PR (Linux + macOS), parallelised via `./scripts/test.sh`
