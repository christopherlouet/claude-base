...
│
├── tests/                       # <!-- count:tests -->457<!-- /count --> automated tests (bats)
...
│   └── ...                      # <!-- count:testFiles -->22<!-- /count --> test files in total
│
...
### Test layout (<!-- count:testFiles -->22<!-- /count --> files, <!-- count:tests -->457<!-- /count --> tests)
