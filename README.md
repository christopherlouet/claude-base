...
[![Tests](https://img.shields.io/badge/tests-1385%20passing-brightgreen)](./tests)
...
| `tests/` | <!-- count:tests -->1385<!-- /count --> bats tests across <!-- count:testFiles -->53<!-- /count --> files |
...
<!-- count:tests -->1385<!-- /count --> bats tests across <!-- count:testFiles -->53<!-- /count --> files. A few anchors :
...
- <!-- count:tests -->1385<!-- /count --> bats tests run on every PR (Linux + macOS), parallelised via `./scripts/test.sh`
