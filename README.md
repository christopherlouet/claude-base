...
[![Tests](https://img.shields.io/badge/tests-1067%20passing-brightgreen)](./tests)
...
| `tests/` | <!-- count:tests -->1067<!-- /count --> bats tests across <!-- count:testFiles -->42<!-- /count --> files |
...
<!-- count:tests -->1067<!-- /count --> bats tests across <!-- count:testFiles -->42<!-- /count --> files. A few anchors :
...
- <!-- count:tests -->1067<!-- /count --> bats tests run on every PR (Linux + macOS), parallelised via `./scripts/test.sh`
