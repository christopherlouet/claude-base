...
| `tests/` | <!-- count:tests -->1112<!-- /count --> bats tests across <!-- count:testFiles -->45<!-- /count --> files |
...
<!-- count:tests -->1112<!-- /count --> bats tests across <!-- count:testFiles -->45<!-- /count --> files. A few anchors :
...
- <!-- count:tests -->1112<!-- /count --> bats tests run on every PR (Linux + macOS), parallelised via `./scripts/test.sh`
