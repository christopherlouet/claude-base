...
| `tests/` | <!-- count:tests -->2022<!-- /count --> bats tests across <!-- count:testFiles -->95<!-- /count --> files |
...
<!-- count:tests -->2022<!-- /count --> bats tests across <!-- count:testFiles -->95<!-- /count --> files. A few anchors :
...
- <!-- count:tests -->2022<!-- /count --> bats tests run on every PR (Linux + macOS), parallelised via `./scripts/test.sh`
