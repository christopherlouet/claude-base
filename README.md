...
[![Tests](https://img.shields.io/badge/tests-927%20passing-brightgreen)](./tests)
...
| `tests/` | <!-- count:tests -->927<!-- /count --> bats tests across <!-- count:testFiles -->37<!-- /count --> files |
...
<!-- count:tests -->927<!-- /count --> bats tests across <!-- count:testFiles -->37<!-- /count --> files. A few anchors :
...
- <!-- count:tests -->927<!-- /count --> bats tests run on every PR (Linux + macOS), parallelised via `./scripts/test.sh`
