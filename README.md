...
| `tests/` | <!-- count:tests -->883<!-- /count --> bats tests across <!-- count:testFiles -->36<!-- /count --> files |
...
<!-- count:tests -->883<!-- /count --> bats tests across <!-- count:testFiles -->36<!-- /count --> files. A few anchors :
...
- <!-- count:tests -->883<!-- /count --> bats tests run on every PR (Linux + macOS), parallelised via `./scripts/test.sh`
