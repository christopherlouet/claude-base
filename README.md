...
[![Tests](https://img.shields.io/badge/tests-891%20passing-brightgreen)](./tests)
...
| `tests/` | <!-- count:tests -->891<!-- /count --> bats tests across <!-- count:testFiles -->36<!-- /count --> files |
...
<!-- count:tests -->891<!-- /count --> bats tests across <!-- count:testFiles -->36<!-- /count --> files. A few anchors :
...
- <!-- count:tests -->891<!-- /count --> bats tests run on every PR (Linux + macOS), parallelised via `./scripts/test.sh`
