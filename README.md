...
[![Tests](https://img.shields.io/badge/tests-701%20passing-brightgreen)](./tests)
...
| `tests/` | <!-- count:tests -->701<!-- /count --> bats tests across <!-- count:testFiles -->32<!-- /count --> files |
...
<!-- count:tests -->701<!-- /count --> bats tests across <!-- count:testFiles -->32<!-- /count --> files. A few anchors :
...
- <!-- count:tests -->701<!-- /count --> bats tests run on every PR (Linux + macOS), parallelised via `./scripts/test.sh`
