...
[![Tests](https://img.shields.io/badge/tests-1652%20passing-brightgreen)](./tests)
...
| `tests/` | <!-- count:tests -->1652<!-- /count --> bats tests across <!-- count:testFiles -->75<!-- /count --> files |
...
<!-- count:tests -->1652<!-- /count --> bats tests across <!-- count:testFiles -->75<!-- /count --> files. A few anchors :
...
- <!-- count:tests -->1652<!-- /count --> bats tests run on every PR (Linux + macOS), parallelised via `./scripts/test.sh`
