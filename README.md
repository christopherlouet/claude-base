...
[![Tests](https://img.shields.io/badge/tests-1201%20passing-brightgreen)](./tests)
...
| `tests/` | <!-- count:tests -->1201<!-- /count --> bats tests across <!-- count:testFiles -->47<!-- /count --> files |
...
<!-- count:tests -->1201<!-- /count --> bats tests across <!-- count:testFiles -->47<!-- /count --> files. A few anchors :
...
- <!-- count:tests -->1201<!-- /count --> bats tests run on every PR (Linux + macOS), parallelised via `./scripts/test.sh`
