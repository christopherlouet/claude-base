...
| `tests/` | <!-- count:tests -->1730<!-- /count --> bats tests across <!-- count:testFiles -->79<!-- /count --> files |
...
<!-- count:tests -->1730<!-- /count --> bats tests across <!-- count:testFiles -->79<!-- /count --> files. A few anchors :
