...
[![Tests](https://img.shields.io/badge/tests-2056%20passing-brightgreen)](./tests)
...
| `tests/` | <!-- count:tests -->2056<!-- /count --> bats tests across <!-- count:testFiles -->97<!-- /count --> files |
...
<!-- count:tests -->2056<!-- /count --> bats tests across <!-- count:testFiles -->97<!-- /count --> files. A few anchors :
...
- <!-- count:tests -->2056<!-- /count --> bats tests run on every PR (Linux + macOS), parallelised via `./scripts/test.sh`
