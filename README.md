...
[![Tests](https://img.shields.io/badge/tests-994%20passing-brightgreen)](./tests)
...
| `tests/` | <!-- count:tests -->994<!-- /count --> bats tests across <!-- count:testFiles -->39<!-- /count --> files |
...
<!-- count:tests -->994<!-- /count --> bats tests across <!-- count:testFiles -->39<!-- /count --> files. A few anchors :
...
- <!-- count:tests -->994<!-- /count --> bats tests run on every PR (Linux + macOS), parallelised via `./scripts/test.sh`
