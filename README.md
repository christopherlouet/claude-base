...
| `tests/` | <!-- count:tests -->692<!-- /count --> bats tests across <!-- count:testFiles -->31<!-- /count --> files |
...
<!-- count:tests -->692<!-- /count --> bats tests across <!-- count:testFiles -->31<!-- /count --> files. A few anchors :
...
- <!-- count:tests -->692<!-- /count --> bats tests run on every PR (Linux + macOS), parallelised via `./scripts/test.sh`
