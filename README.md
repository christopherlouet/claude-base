...
[![Tests](https://img.shields.io/badge/tests-679%20passing-brightgreen)](./tests)
...
| `tests/` | <!-- count:tests -->679<!-- /count --> bats tests across <!-- count:testFiles -->30<!-- /count --> files |
...
<!-- count:tests -->679<!-- /count --> bats tests across <!-- count:testFiles -->30<!-- /count --> files. A few anchors :
...
- <!-- count:tests -->679<!-- /count --> bats tests run on every PR (Linux + macOS), parallelised via `./scripts/test.sh`
