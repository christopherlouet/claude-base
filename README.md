...
[![Tests](https://img.shields.io/badge/tests-689%20passing-brightgreen)](./tests)
...
| `tests/` | <!-- count:tests -->689<!-- /count --> bats tests across <!-- count:testFiles -->31<!-- /count --> files |
...
<!-- count:tests -->689<!-- /count --> bats tests across <!-- count:testFiles -->31<!-- /count --> files. A few anchors :
...
- <!-- count:tests -->689<!-- /count --> bats tests run on every PR (Linux + macOS), parallelised via `./scripts/test.sh`
