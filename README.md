...
[![Tests](https://img.shields.io/badge/tests-2042%20passing-brightgreen)](./tests)
...
| `tests/` | <!-- count:tests -->2042<!-- /count --> bats tests across <!-- count:testFiles -->96<!-- /count --> files |
...
<!-- count:tests -->2042<!-- /count --> bats tests across <!-- count:testFiles -->96<!-- /count --> files. A few anchors :
...
- <!-- count:tests -->2042<!-- /count --> bats tests run on every PR (Linux + macOS), parallelised via `./scripts/test.sh`
