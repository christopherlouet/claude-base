...
| `tests/` | <!-- count:tests -->1767<!-- /count --> bats tests across <!-- count:testFiles -->80<!-- /count --> files |
...
<!-- count:tests -->1767<!-- /count --> bats tests across <!-- count:testFiles -->80<!-- /count --> files. A few anchors :
...
- <!-- count:tests -->1767<!-- /count --> bats tests run on every PR (Linux + macOS), parallelised via `./scripts/test.sh`
