...
```bash
curl -fsSL https://raw.githubusercontent.com/christopherlouet/claude-base/main/install.sh | bash -s -- --ref v5.5.0
```
...
- Pinned versions via git tags (current : v<!-- version -->5.5.0<!-- /version -->) with full `CHANGELOG.md` in Keep-a-Changelog format
