...
[![Tests](https://img.shields.io/badge/tests-1691%20passing-brightgreen)](./tests)
...
| `tests/` | <!-- count:tests -->1691<!-- /count --> bats tests across <!-- count:testFiles -->76<!-- /count --> files |
...
<!-- count:tests -->1691<!-- /count --> bats tests across <!-- count:testFiles -->76<!-- /count --> files. A few anchors :
...
- <!-- count:tests -->1691<!-- /count --> bats tests run on every PR (Linux + macOS), parallelised via `./scripts/test.sh`
