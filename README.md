...
[![Tests](https://img.shields.io/badge/tests-627%20passing-brightgreen)](./tests)
...
- **<!-- count:presets -->7<!-- /count --> stack-specific presets** (`nextjs`, `react-vite-spa`, `fastapi`, `astro`, `cli-tools`, `homelab-proxmox`) installable via `claude-base init --preset <name> <path>`
...
│
├── tests/                       # <!-- count:tests -->627<!-- /count --> automated tests (bats)
...
### Test layout (<!-- count:testFiles -->28<!-- /count --> files, <!-- count:tests -->627<!-- /count --> tests)
