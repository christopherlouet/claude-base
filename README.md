...
[![Tests](https://img.shields.io/badge/tests-2094%20passing-brightgreen)](./tests)
...
| `tests/` | <!-- count:tests -->2094<!-- /count --> bats tests across <!-- count:testFiles -->100<!-- /count --> files |
...
<!-- count:tests -->2094<!-- /count --> bats tests across <!-- count:testFiles -->100<!-- /count --> files. A few anchors :
...
- <!-- count:tests -->2094<!-- /count --> bats tests run on every PR (Linux + macOS), parallelised via `./scripts/test.sh`
