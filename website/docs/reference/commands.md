...
description: "Installable horizontal domain modules (biz, legal, growth) are managed with three `claude-base` verbs. They work on an **already-initialized project**"
tags:
  - "reference"
---
