...
|-----------|-------------|
| [Commands matrix](/docs/reference/commands-matrix) | <!-- count:commands -->106<!-- /count --> commands with domain and description |
| [Agents matrix](/docs/reference/agents-matrix) | <!-- count:agents -->44<!-- /count --> agents with model and tools |
...
| [DEV](/docs/commands/dev) | <!-- count:byDomain.dev -->16<!-- /count --> | Development |
| [QA](/docs/commands/qa) | <!-- count:byDomain.qa -->13<!-- /count --> | Quality |
| [OPS](/docs/commands/ops) | <!-- count:byDomain.ops -->28<!-- /count --> | Operations |
| [DOC](/docs/commands/doc) | <!-- count:byDomain.doc -->5<!-- /count --> | Documentation |
| [BIZ](/docs/commands/biz) | <!-- count:byDomain.biz -->9<!-- /count --> | Business |
| [GROWTH](/docs/commands/growth) | <!-- count:byDomain.growth -->9<!-- /count --> | Growth |
...
| Agents | <!-- count:agents -->44<!-- /count --> | [View](/docs/agents) |
