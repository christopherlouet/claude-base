...
|-----------|-------------|
| [Commands matrix](/docs/reference/commands-matrix) | <!-- count:commands -->117<!-- /count --> commands with domain and description |
...
|-----------|--------|------|
| Commands | <!-- count:commands -->117<!-- /count --> | [View](/docs/commands) |
