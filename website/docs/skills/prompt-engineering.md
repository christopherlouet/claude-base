...
> Optimisation de prompts pour LLMs. Declencher quand l'utilisateur veut ameliorer un prompt, ajouter des exemples, ou structurer des instructions.
...
| **Mots-cles** | `prompt`, `engineering`, `instruction`, `system message`, `few-shot`, `exemples` |
...
- _"Je veux prompt..."_
- _"Je veux engineering..."_
- _"Je veux instruction..."_
