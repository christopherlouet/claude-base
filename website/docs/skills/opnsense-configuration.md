...
> Configuration OPNsense via Terraform. Declencher pour interfaces, firewall, NAT, DHCP/DNS, aliases.
...
| **Mots-cles** | `opnsense`, `configuration`, `browningluke/opnsense`, `~> 0.11`, `opnsense_interface`, `wan` |
