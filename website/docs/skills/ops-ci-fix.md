...
> Diagnostic et reparation autonome des pipelines CI/CD en echec. Scanner les workflows GitHub Actions, identifier les causes de failure, et appliquer des fixes. Declencher quand la CI est cassee, les tests echouent en CI, ou les workflows sont bloques.
