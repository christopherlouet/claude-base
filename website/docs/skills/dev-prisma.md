...
> Developpement avec Prisma ORM (schema, migrations, queries type-safe, Accelerate, transactions). Declencher quand l'utilisateur veut ajouter un modele, creer une migration, optimiser des queries Prisma, ou quand on detecte schema.prisma dans le projet.
