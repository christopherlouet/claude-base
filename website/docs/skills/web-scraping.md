...
|-----------|--------|
| **Contexte** | fork |
| **Outils autorises** | `Read`, `Write`, `Bash`, `WebFetch`, `WebSearch` |
| **Mots-cles** | `web`, `scraping`, `extrait les donnees de ...`, `crawle le site x`, `parse cette page dynamique` |
...
- _"Je veux web..."_
- _"Je veux scraping..."_
- _"Je veux extrait les donnees de ......"_
