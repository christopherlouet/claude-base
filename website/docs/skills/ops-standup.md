...
> Briefing matinal cross-repo. Agregation des commits recents, PRs, CI, blockers et priorites du jour. Declencher quand l'utilisateur veut un standup, un resume d'activite, ou savoir ce qui s'est passe.
