...
> Orchestration d'equipes d'agents avec Agent Teams natif. Declencher quand l'utilisateur veut lancer une equipe d'agents, coordonner du travail parallele avec communication inter-agents, ou utiliser le mode swarm.
