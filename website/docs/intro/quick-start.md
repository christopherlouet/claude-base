...
<WorkflowDiagram steps={MAIN_WORKFLOW} title="Workflow principal : Explore → Specify → Plan → TDD → Commit" />
...
- [Explorer les commandes](/docs/commands) - Catalogue complet des 120 commandes
