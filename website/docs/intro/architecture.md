...
graph TB
    ...
    subgraph ".claude/"
        CMDS[commands/<br/>119 commandes]
        AGENTS[agents/<br/>57 sub-agents]
        SKILLS[skills/<br/>41 skills]
...
claude-socle/
├── .claude/
│   ├── commands/       # 119 commandes manuelles (/nom)
...
│   ├── skills/         # 41 skills auto-declenches
...
- [Commands](/docs/commands) - Explorer les 119 commandes
