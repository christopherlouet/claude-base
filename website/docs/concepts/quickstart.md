...
- See [CLAUDE.md](https://github.com/christopherlouet/claude-base/blob/main/CLAUDE.md) for full documentation
- See [ARCHITECTURE.md](/docs/concepts/architecture) to understand Commands vs Agents vs Skills

## Resources

- [Cheatsheet](/docs/reference/cheatsheet) - Quick reference
- [Customization](/docs/concepts/customization) - Customization
