...
- **<!-- count:commands -->110<!-- /count --> commands** organized by domain (WORK, DEV, QA, OPS, etc.)
- **<!-- count:agents -->46<!-- /count --> agents** specialized with isolated context
...
|--------|---------------------|--------------|
| Commands | Basic commands | <!-- count:commands -->110<!-- /count --> specialized commands |
| Workflow | Free | Structured (Explore → Plan → TDD) |
| Agents | No | <!-- count:agents -->46<!-- /count --> agents with isolated context |
