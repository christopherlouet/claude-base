...
|--------------------------|-------------|
| <!-- count:commands -->110<!-- /count --> commands (`/work:*`, `/dev:*`, `/qa:*`, `/ops:*`) | Pre-written workflows for common tasks |
| <!-- count:agents -->46<!-- /count --> specialized agents | Sub-processes for audit, security, tests, etc. |
