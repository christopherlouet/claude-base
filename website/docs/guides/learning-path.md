...
- **<!-- count:agents -->44<!-- /count --> agents**: specialized sub-processes that activate automatically for analysis or audit tasks
...
The foundation currently contains: <!-- count:commands -->106<!-- /count --> commands, <!-- count:skills -->53<!-- /count --> skills, <!-- count:agents -->44<!-- /count --> agents, <!-- count:rules -->32<!-- /count --> rules (indicative numbers, verify with `.claude/`). This ratio reflects a philosophy: commands are the main entry point, agents are specialized and constrained, skills provide the substance.
