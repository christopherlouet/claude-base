...
- **<!-- count:commands -->112<!-- /count --> commands**: pre-written instructions for common tasks (`/work:work-explore`, `/dev:dev-tdd`, `/qa:qa-security`, etc.)
...
Claude-base organizes its <!-- count:commands -->112<!-- /count --> commands into 9 domains. Each domain covers an aspect of software development.
