...
- **<!-- count:commands -->114<!-- /count --> commands**: pre-written instructions for common tasks (`/work:work-explore`, `/dev:dev-tdd`, `/qa:qa-security`, etc.)
- **<!-- count:agents -->47<!-- /count --> agents**: specialized sub-processes that activate automatically for analysis or audit tasks
...
The <!-- count:agents -->47<!-- /count --> agents are grouped into the same domains as the commands. Haiku agents (22) are used for fast and economical tasks (exploration, documentation, simple audits). Sonnet agents (35) for complex analyses (security, performance, debug, architecture).
...
The <!-- count:rules -->31<!-- /count --> rules of the foundation cover:
...
Claude-base organizes its <!-- count:commands -->114<!-- /count --> commands into 9 domains. Each domain covers an aspect of software development.
...
| Opus 4.8 | Critical audit, complex architecture, `/effort high` | High |
