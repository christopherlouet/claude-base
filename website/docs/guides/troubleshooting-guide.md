...
- [Available commands](/docs/reference/cheatsheet) - the `/work:`, `/dev:`, `/qa:`, `/ops:` commands, by intent
- [Essential shell commands](/docs/reference/commands) - npm, flutter, pytest… per stack
