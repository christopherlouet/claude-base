...
|---------|----------|-------------|
| [Composant React](/docs/examples/web/react-component) | `/dev-component` | Composant complet avec tests et stories |
| [Hook personnalisé](/docs/examples/web/react-hook) | `/dev-hook` | Custom hook avec gestion d'état |
| [API Next.js](/docs/examples/web/nextjs-api) | `/dev-api` | Route API avec validation |

## Mobile (Flutter)

| Exemple | Commande | Description |
|---------|----------|-------------|
| [Screen Flutter](/docs/examples/mobile/flutter-screen) | `/dev-flutter` | Screen avec Clean Architecture |
| [BLoC Pattern](/docs/examples/mobile/flutter-bloc) | `/dev-flutter` | State management avec BLoC |

## API (REST/GraphQL/tRPC)

| Exemple | Commande | Description |
|---------|----------|-------------|
| [Endpoint REST](/docs/examples/api/rest-endpoint) | `/dev-api` | Endpoint CRUD complet |
...
| Exemple | Commande | Description |
|---------|----------|-------------|
| [Setup Docker](/docs/examples/ops/docker-setup) | `/ops-docker` | Dockerfile multi-stage |
...
3. **Générer les tests** avec `/dev-test`
4. **Commiter** avec `/work-commit`

:::tip Générer du code similaire
Utilisez la commande associée à chaque exemple pour générer du code adapté à votre contexte :
```bash
/dev-component "Créer un composant UserProfile avec avatar et bio"
```
:::
