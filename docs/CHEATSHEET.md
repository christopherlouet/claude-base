...
*Claude-Base v<!-- version -->1.38.0<!-- /version --> - <!-- count:commands -->131<!-- /count --> commands - <!-- count:agents -->63<!-- /count --> agents - <!-- count:skills -->54<!-- /count --> skills - <!-- count:rules -->30<!-- /count --> rules*
