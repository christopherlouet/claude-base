...
*Claude-Base v<!-- version -->2.0.0<!-- /version --> - <!-- count:commands -->128<!-- /count --> commands - <!-- count:agents -->61<!-- /count --> agents - <!-- count:skills -->53<!-- /count --> skills - <!-- count:rules -->30<!-- /count --> rules*
